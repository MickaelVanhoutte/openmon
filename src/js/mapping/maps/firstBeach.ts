...
const sparseData: SparseMapData = {
	...
	battleIndices: [
		874, 875, 876, 1024, 1025, 1026, 1030, 1031, 1032, 1174, 1175, 1176, 1180, 1181, 1182, 1188,
		1330, 1331, 1332, 1475, 1767, 1768, 1769, 1770, 1916, 1917, 1918, 1919, 1920, 2062, 2063, 2064,
		2065, 2066, 2067, 2068, 2069, 2070, 2072, 2212, 2213, 2214, 2215, 2216, 2217, 2218, 2219, 2220,
		2221, 2222, 2223, 2362, 2363, 2364, 2365, 2366, 2367, 2368, 2369, 2370, 2371, 2372, 2373, 2667,
		2668, 2669, 2670, 2811, 2812, 2813, 2817, 2818, 2819, 2820, 2821, 2822, 2823, 2961, 2962, 2963,
		2968, 2969, 2970, 2971, 2972, 2973, 3111, 3112, 3113, 3117, 3118, 3119, 3120, 3121, 3122, 3123,
		3268, 3269, 3270, 3271, 3272, 3418, 3419, 3420, 3421
	]
};
				...
				new Script('onInteract', [
					...
					new CustomScriptable((ctx) => {
						...
						for (let i = 4001; i <= 4022; i++) {
							ctx.player.bag.addHeldItem(i, 1, ctx.ITEMS);
						}
